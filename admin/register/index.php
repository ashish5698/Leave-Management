...
if(isset($_SESSION['adminuser']))
	...
	<table>
	<tr><td><div class = 'error'>*</div> Student Name : </td><td><input type = 'text' name = 'empname' class = 'reg-form-fields shadow selected' placeholder = 'Student Name'></td></tr><br>
...
<tr><td><div class = 'error'>*</div> Student Type : </td><td><select name = 'factype' class = 'reg-form-fields shadow selected'>
