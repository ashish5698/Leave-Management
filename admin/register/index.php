...
if(isset($_SESSION['adminuser']))
	...
	<table>
	<tr><td><div class = 'error'>*</div> Student Name : </td><td><input type = 'text' name = 'stuname' class = 'reg-form-fields shadow selected' placeholder = 'Student Name'></td></tr><br>
<tr><td><div class = 'error'>*</div> Username : </td><td><input type = 'text' name = 'uname' class = 'reg-form-fields shadow selected' placeholder = 'Student Username'></td></tr><br>
...
<tr><td><div class = 'error'>*</div> Student email id : </td><td><input type = 'text' name = 'mailid' class = 'reg-form-fields shadow selected' placeholder = 'Student Email ID'></td></tr><br>
<tr><td><div class = 'error'>*</div> Designation : </td><td><input type = 'text' name = 'designation' class = 'reg-form-fields shadow selected' placeholder = 'Student Designation'></td></tr><br>
<tr><td><div class = 'error'>*</div> stuloyment Type : </td><td><select name = 'factype' class = 'reg-form-fields shadow selected'>
