						...
						if($row["UserName"] == $user)
							{
								if($leavetype === "Sick Leave")
								{
									if(($leavedays <= $row["SickLeave"]) || $leavedays < 0)
										...
										$stuname = $row["stuName"];
										$to = $row["stuEmail"];
										$sql2 = "INSERT INTO stu_leaves(stuName,LeaveType,LeaveDays,StartDate,EndDate,Dept) VALUES('".$stuname."','".$leavetype."','".$leavedays."','".$leavedate."','".$end."','".$row['Dept']."')";
...
$pdf_content='
			...
			<tr><th>Student Designation : </th><td>'.$designation.'</td></tr>
			<tr><th>stuloyment Type : </th><td>'.$stutype.'</td></tr>
			<tr><th>Student Department : </th><td>'.$dept.'</td></tr>
			<tr><th>Student Fee Structure : </th><td>'.$stufee.'</td></tr>
